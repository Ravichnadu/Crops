...
public class CropsApi {
	...
	@PostMapping("/crops")
	public ResponseEntity<CropsDto> addCrops(@RequestParam("name") String name,
			                                  ...
			                                  @RequestParam("dhalaries") List<Dhalary> dhalaries) throws IOException 
	{
		...
		String convertToBase64 = cropsService.convertToBase64(imageData);
		CropsDto dto=new CropsDto(name, price, type, convertToBase64, dhalaries);
